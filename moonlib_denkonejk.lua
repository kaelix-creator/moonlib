...
local redzlib = {
    Themes = {
        ...
        Dark = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 18, 16)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(15, 18, 16)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 18, 16))
            }),
            ["Color Hub 2"] = Color3.fromRGB(20, 24, 22), -- fundo dos painéis
            ["Color Stroke"] = Color3.fromRGB(60, 255, 140), -- verde neon borda
            ["Color Theme"] = Color3.fromRGB(60, 255, 140), -- botões / toggles
            ["Color Text"] = Color3.fromRGB(255, 255, 255), -- texto principal
            ["Color Dark Text"] = Color3.fromRGB(180, 180, 180) -- texto secundário
        },
    }, 
